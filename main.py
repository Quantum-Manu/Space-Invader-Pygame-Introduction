...
pygame.display.set_caption("SPACE INVADERS: FIRST GAME")
...
def draw_window(SPACE, red, yellow, red_bullets, yellow_bullets, red_health,
                yellow_health):
    WIN.blit(SPACE, (0, 0))
...
def yellow_handle_movement(keys_pressed, yellow):
    ...
    if keys_pressed[
            pygame.
            K_s] and yellow.y + VEL + yellow.height < HEIGHT - 15:  # DOWN
        yellow.y += VEL
...
def main():
    ...
    while run:
        ...
        draw_window(SPACE, red, yellow, red_bullets, yellow_bullets,
